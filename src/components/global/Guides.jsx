...
const Guides = () => {
  ...
  const guides = [
    ...
    {
        title: 'Remove BG From HTML From Text Long Title Text',
        image: 'https://deep-image.ai/blog/content/images/2022/09/underwater-magic-world-8tyxt9yz.jpeg',
        link: '',
        views: '305',
        author: 'Dylan S.',
    ...
    {
        title: 'Remove BG From PDF From Text Long Title Text',
        image: 'https://deep-image.ai/blog/content/images/2022/09/underwater-magic-world-8tyxt9yz.jpeg',
        link: '',
        views: '418',
        author: 'Charles K.',
    ...
    {
        title: 'Remove BG From Blank From Text Long Title Text',
        image: 'https://deep-image.ai/blog/content/images/2022/09/underwater-magic-world-8tyxt9yz.jpeg',
        link: '',
        views: '265',
        author: 'Dylan S. & Charles K.',
  ...
  return (
    <div id="upscaleHome_guides" className="flex flex-col items-center bg-stone-950 gap-10 py-24 px-4">
        <div id="upscaleHome_guides-optionsAndGuides" className="w-full flex flex-col items-center gap-4">
            ...
            <div id="upscaleHome_guides-optionsAndGuides-options" className="flex gap-4 max-w-[1250px] justify-start w-full mb-6">

...
const UpscaleBlog = () => {
  return (
    <div id="upscaleHome_blogPiece" className="flex flex-col items-center bg-black py-[2em] gap-20 px-4">
          
        <div id="upscaleHome_blogPiece-top" className="w-full flex flex-col md:flex-row justify-center md:gap-32">
        
          <div id="upscaleHome_blogPiece-info" className="w-full flex flex-col items-center md:max-w-[450px] gap-6">
          ...
          <div id="upscaleHome_blogPiece-blogList" className="w-full md:max-w-[600px]">
              
              <div id="slider1" className="w-full h-full md:w-[90%] md:h-[90%] bg-stone-900 rounded-3xl">
              hello
              </div>
        ...
        <div id="upscaleHome_blogPiece-bottom" className="flex justify-center">
          ...
          <div className="bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-sky-400 to-indigo-900  p-[1px] w-full md:max-w-[220px] rounded-xl cursor-pointer group">

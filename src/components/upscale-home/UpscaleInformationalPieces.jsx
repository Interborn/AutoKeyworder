...
const UpscaleInformationalPieces = () => {
  return (
    <div id="upscaleHome_pieces" className="w-full flex flex-col items-center bg-stone-950 py-[2em] px-4">
          
        <div id="upscaleHome_pieces-header" className="flex flex-col items-center ">
        
            <h3 className="font-bold text-[44px] text-white">Photographic Features</h3>
            <p className="font-bold text-[20px] text-white max-w-[60ch] text-left sm:text-center">Explore the features of our AI enhancement software that significantly increase your productivity!</p>

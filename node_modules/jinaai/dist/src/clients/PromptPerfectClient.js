...
exports.PromptPerfectClient = void 0;
...
var PromptPerfectClient = (function (_super) {
    ...
    function PromptPerfectClient(params) {
        var headers = params.headers, options = params.options, _a = params.baseURL, baseURL = _a === void 0 ? 'https://api.promptperfect.jina.ai' : _a;
        var defaultHeaders = {
    ...
    PromptPerfectClient.prototype.toSimplifiedOutout = function (output) {
        if (!output.result || output.result.every(function (x) { return x.promptOptimized != ''; }) == false)
            throw 'Remote API Error, bad output: ' + JSON.stringify(output);
        return {
            results: output.result.map(function (r) { return ({
...
exports.PromptPerfectClient = PromptPerfectClient;
